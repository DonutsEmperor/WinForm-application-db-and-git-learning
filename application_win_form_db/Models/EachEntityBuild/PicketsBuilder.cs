	...
	internal static class PicketsBuilder
	{
		public static void PicketsBuild(this ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<Picket>().HasData(
				new Picket { PicketId = 1, Latitude = 41.730610m, Longitude = -73.935242m, SurveyLineId = 1 },
				new Picket { PicketId = 2, Latitude = 34.052235m, Longitude = -118.243683m, SurveyLineId = 2 },
				new Picket { PicketId = 3, Latitude = 43.507351m, Longitude = -73.935242m, SurveyLineId = 1 },
				...
				new Picket { PicketId = 6, Latitude = 45.733610m, Longitude = -73.935242m, SurveyLineId = 1 },
				new Picket { PicketId = 7, Latitude = 47.130610m, Longitude = -73.935242m, SurveyLineId = 1 }
			);
