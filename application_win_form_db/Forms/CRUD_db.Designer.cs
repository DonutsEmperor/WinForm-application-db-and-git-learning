namespace application_win_form_db
{
    partial class CRUD_db
    {
		...
		private void InitializeComponent()
		{
			...
			lbl_choose.Size = new Size(126, 21);
			lbl_choose.TabIndex = 10;
			lbl_choose.Text = "Choose the table";
			// 
			// cmbBx_tables
			// 
			cmbBx_tables.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// btn_c
			// 
			btn_c.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// button_u
			// 
			button_u.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// button_d
			// 
			button_d.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// btn_sort_desc
			// 
			btn_sort_desc.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			// btn_sort_asc
			// 
			btn_sort_asc.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			lbl_sort.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			lbl_sort.Location = new Point(945, 77);
			lbl_sort.Name = "lbl_sort";
			lbl_sort.Size = new Size(61, 21);
			lbl_sort.TabIndex = 18;
			lbl_sort.Text = "Sorting";
			// 
			// cmbBx_columns
			// 
			cmbBx_columns.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point);
			...
			cmbBx_columns.Size = new Size(175, 29);
